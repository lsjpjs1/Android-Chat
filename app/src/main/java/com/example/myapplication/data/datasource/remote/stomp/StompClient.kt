...
import com.example.myapplication.data.datasource.remote.stomp.constants.Codes
import com.example.myapplication.data.datasource.remote.stomp.constants.Commands
import com.example.myapplication.data.datasource.remote.stomp.constants.Headers
...
class StompClient(
    ...
    private fun handleMessage(message: Message) {
        ...
        logger.log(
            Level.INFO,
            "onMessage payload: ${message.payload}, heaaders:${message.headers}, command: ${message.command}"
        )
    }
